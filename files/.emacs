...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode pdf-tools jinja2-mode lua-mode markdown-mode ess use-package standoff-mode stan-mode solarized-theme quarto-mode org-ref elfeed csv-mode auctex-latexmk))
